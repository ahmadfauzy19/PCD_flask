...
def ekstra_citra(lokasi_citra):
    ...
    _, citra_biner = cv2.threshold(citra, 200, 255, cv2.THRESH_BINARY_INV)
...
def simpan_gambar():
    ...
    nama_citra = []
    digit = ["nol", "satu", "dua", "tiga", "empat", "lima", "enam", "tujuh", "delapan", "sembilan", "blush", "disappointed_relieved", "expressionless", "face_with_raised_eyebrow", "face_with_rolling_eyes", "grin", "grinning", "heart_eyes", "hugging_face", "joy", "kissing", "kissing_closed_eyes", "kissing_heart", "kissing_smiling_eyes", "laughing", "neutral_face", "no_mouth", "open_mouth", "persevere", "relaxed", "rolling_on_the_floor_laughing", "sleeping", "sleepy", "slightly_smiling_face", "smile", "smiley", "smirk", "star-struck", "sunglasses", "sweat_smile", "thinking_face", "tired_face", "wink", "yum", "zipper_mouth_face", "hushed"]
    # digit = ["nol", "satu", "dua", "tiga", "empat", "lima", "enam", "tujuh", "delapan", "sembilan", "grinning", "sleepy"]
    nama_citra = ["nol", "satu", "dua", "tiga", "empat", "lima", "enam", "tujuh", "delapan", "sembilan", "blush", "disappointed_relieved", "expressionless", "face_with_raised_eyebrow", "face_with_rolling_eyes", "grin", "grinning", "heart_eyes", "hugging_face", "joy", "kissing", "kissing_closed_eyes", "kissing_heart", "kissing_smiling_eyes", "laughing", "neutral_face", "no_mouth", "open_mouth", "persevere", "relaxed", "rolling_on_the_floor_laughing", "sleeping", "sleepy", "slightly_smiling_face", "smile", "smiley", "smirk", "star-struck", "sunglasses", "sweat_smile", "thinking_face", "tired_face", "wink", "yum", "zipper_mouth_face", "hushed"]
    for i, nama in enumerate(nama_citra):
        digit_1 = digit[i]
